...
public class CompanyDetailsScreen extends ElementInteraction {
    ...
    public CompanyDetailsScreen getExpectedTransactionFromHistory(String formName, String docReceivedDate, String
            transactionStatus, String transactionDescription, String user) {
        ...
        transactionToFind.put("User", user);
    ...
    private WebElement checkHistoryTableRow(Map<String, String> transactionToFind) {
        ...
        final String userColumn = "form1:viewTCL:viewTHCL:_THCLDataTableUsed:THCLDataTableFrag:"
                + "transactionHistoryAndContactLog_unfilteredDataModel:%d:user";
        for (int i = 0; i < allTransactionsList.size(); i++) {
            ...
            String user = String.valueOf(webElement.findElement(By.id(String
                    .format(userColumn, i))).getText());
            ...
            if (formType.equals(transactionToFind.get("Form"))
                    ...
                    + "description"))
                    && user.equals(transactionToFind.get("User"))) {

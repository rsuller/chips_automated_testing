---
--- private limited company ro in engwales id with an CVL action code
--- Companies with any CVL ceased case will be ignored, as we want to make sure the automated test is not going to pick up
...
FROM corporate_body cb
             ...
             AND cb.action_code_type_id = 7002
